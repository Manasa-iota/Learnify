            ...
            <section className="mx-auto p-8 transition duration-500">
                ...
                <div className="flex flex-col md:mx-20 gap-4">
                    ...
                    <div className="border rounded-lg p-4  transform transition-transform hover:shadow-lg">
                        ...
                        Learnify is a fully functional ed-tech platform designed to create, consume, and rate educational content. It offers a seamless and interactive learning experience for students while providing a platform for instructors to showcase their expertise.
                        </div>
                    </div>
                    ...
                    <div className="border rounded-lg p-4 hover:shadow-lg transform transition-transform">
                        <button className="w-full flex justify-between text-lg font-medium focus:outline-none" onClick={() => toggleAnswer('faq2', 'arrow2')}>
                            <span>Is Learnify free to use, or are there subscription plans?</span>
                        ...
                        Learnify offers various plans, including free access with limited features and premium subscription plans with additional benefits. Users can choose a plan that suits their needs and upgrade to unlock more features.
                        </div>
                    </div>
                    ...
                    <div className="border rounded-lg p-4 hover:shadow-lg transform transition-transform">
                        <button className="w-full flex justify-between text-lg font-medium focus:outline-none" onClick={() => toggleAnswer('faq3', 'arrow3')}>
                            <span>Can I customize my profile on Learnify?</span>
                        ...
                        Yes, users can customize their profiles on Learnify. After creating an account, you can add information about yourself, such as your education background, interests, and profile picture. Customizing your profile helps personalize your experience on the platform.
                        </div>
                    </div>
                    ...
                    <div className="border rounded-lg p-4 hover:shadow-lg transform transition-transform">
                        <button className="w-full flex justify-between text-lg font-medium focus:outline-none" onClick={() => toggleAnswer('faq4', 'arrow4')}>
                            <span>How can I create educational content on Learnify?</span>
                        ...
                        As an instructor, you can create educational content on Learnify by accessing the content creation tools available on the platform. These tools allow you to upload course materials, videos, quizzes, and other educational resources to share with learners.
                        </div>
                    </div>
                </div>  
            </section>
