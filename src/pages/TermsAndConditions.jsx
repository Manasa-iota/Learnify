          ...
          <TitleWrapper className="text-center">
            <PolicyWrapper className="terms">
              <Section className="text-left">
                ...
                <Paragraph>
                  Welcome to Study Notion. These terms and conditions outline the rules and regulations for the use of Study Notion's Website, located at www.Learnifym.
                </Paragraph>
              </Section>
              <Section className="text-left">
              ...
              <Section className="text-left">
                ...
                <Paragraph>
                  ...
                  <br />please contact us at: Email: support@Learnifym
                </Paragraph>
              </Section>
            </PolicyWrapper>
          </TitleWrapper>
